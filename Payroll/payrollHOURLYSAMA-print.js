...
const HOURLY_DEFAULT_RETURN_URL = "payrollHOURLYSAMA.html";
...
(function () {
  ...
  function getReturnUrl() {
    return sessionStorage.getItem(HOURLY_PRINT_RETURN_KEY) || HOURLY_DEFAULT_RETURN_URL;
  }

  function cleanupPrintSession() {
    sessionStorage.removeItem(HOURLY_PRINT_PAYLOAD_KEY);
    sessionStorage.removeItem(HOURLY_PRINT_RETURN_KEY);
  }
  ...
  function renderPayload() {
    const payload = sessionStorage.getItem(HOURLY_PRINT_PAYLOAD_KEY);
