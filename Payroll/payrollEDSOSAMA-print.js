...
const EDSOSAMA_DEFAULT_RETURN_URL = "payrollEDSOSAMA.html";
...
(function () {
  ...
  function getReturnUrl() {
    return sessionStorage.getItem(EDSOSAMA_PRINT_RETURN_KEY) || EDSOSAMA_DEFAULT_RETURN_URL;
  }

  function cleanupPrintSession() {
    sessionStorage.removeItem(EDSOSAMA_PRINT_PAYLOAD_KEY);
    sessionStorage.removeItem(EDSOSAMA_PRINT_RETURN_KEY);
  }
  ...
  function normalizePayload(payload) {
    ...
    const nestedRoot = template.content.querySelector("#printRoot");
    if (nestedRoot) return nestedRoot.innerHTML;

    return payload;
  }

  function renderPayload() {
    const payload = sessionStorage.getItem(EDSOSAMA_PRINT_PAYLOAD_KEY);
    const root = document.getElementById("printRoot");
    ...
    root.innerHTML = normalizePayload(payload);
    return true;
  }
