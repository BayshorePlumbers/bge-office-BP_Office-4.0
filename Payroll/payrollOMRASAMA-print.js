...
const OMRASAMA_DEFAULT_RETURN_URL = "payrollOMRASAMA.html";
...
(function () {
  ...
  function getReturnUrl() {
    return sessionStorage.getItem(OMRASAMA_PRINT_RETURN_KEY) || OMRASAMA_DEFAULT_RETURN_URL;
  }

  function cleanupPrintSession() {
    sessionStorage.removeItem(OMRASAMA_PRINT_PAYLOAD_KEY);
    sessionStorage.removeItem(OMRASAMA_PRINT_RETURN_KEY);
  }
  ...
  function renderPayload() {
    const payload = sessionStorage.getItem(OMRASAMA_PRINT_PAYLOAD_KEY);
    const root = document.getElementById("printRoot");
