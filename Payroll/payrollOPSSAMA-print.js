...
const OPS_SAMA_DEFAULT_RETURN_URL = "payrollOPSSAMA.html";
...
(function () {
  ...
  function getReturnUrl() {
    return sessionStorage.getItem(OPS_SAMA_PRINT_RETURN_KEY) || OPS_SAMA_DEFAULT_RETURN_URL;
  }

  function cleanupPrintSession() {
    sessionStorage.removeItem(OPS_SAMA_PRINT_PAYLOAD_KEY);
    sessionStorage.removeItem(OPS_SAMA_PRINT_RETURN_KEY);
  }
  ...
  function waitForLayoutReady() {
    const root = document.getElementById("printSheet");
  ...
  function renderPayload() {
    const payload = sessionStorage.getItem(OPS_SAMA_PRINT_PAYLOAD_KEY);
