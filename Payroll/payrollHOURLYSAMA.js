(function () {
  ...
  function wireTooltips() {
    ...
    function requireValidTechOrAlert() {
        ...
        alert('Sales Rep Name must be exactly "Alberto Lopez" or "Jose Rodriguez" or "Juan Hernandez" or "Kevin Perez" or "Ryan Felt".');
        if (els.tn) {
            els.tn.value = "";
            els.tn.focus();
        }
    ...
    const ALLOWED_TECHS = ["Alberto Lopez", "Jose Rodriguez", "Juan Hernandez", "Kevin Perez", "Ryan Felt"];
