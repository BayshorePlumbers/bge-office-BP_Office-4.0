...
const HTECHSAMA_DEFAULT_RETURN_URL = "htechSAMA.html";
...
(function () {
  ...
  function getReturnUrl() {
    return sessionStorage.getItem(HTECHSAMA_PRINT_RETURN_KEY) || HTECHSAMA_DEFAULT_RETURN_URL;
  }

  function cleanupPrintSession() {
    sessionStorage.removeItem(HTECHSAMA_PRINT_PAYLOAD_KEY);
    sessionStorage.removeItem(HTECHSAMA_PRINT_RETURN_KEY);
  }
  ...
  function installReturnListeners() {
    ...
    function renderPayload() {
        const payload = sessionStorage.getItem(HTECHSAMA_PRINT_PAYLOAD_KEY);
        const sheet = document.getElementById("printSheet");
        const root = document.getElementById("printRoot");

        if (!sheet || !root) return false;
        ...
        const payloadRoot = doc.querySelector("#printRoot");

        if (payloadRoot) {
        root.innerHTML = payloadRoot.innerHTML;
        } else {
