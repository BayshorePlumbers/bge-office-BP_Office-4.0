...
const HTECH_EGSAMA_DEFAULT_RETURN_URL = "htechEGSAMA.html";
...
(function () {
  ...
  function getReturnUrl() {
    return sessionStorage.getItem(HTECH_EGSAMA_PRINT_RETURN_KEY) || HTECH_EGSAMA_DEFAULT_RETURN_URL;
  }

  function cleanupPrintSession() {
    sessionStorage.removeItem(HTECH_EGSAMA_PRINT_PAYLOAD_KEY);
    sessionStorage.removeItem(HTECH_EGSAMA_PRINT_RETURN_KEY);
  }
  ...
  function renderPayload() {
    const payload = sessionStorage.getItem(HTECH_EGSAMA_PRINT_PAYLOAD_KEY);
    const root = document.getElementById("printRoot");
