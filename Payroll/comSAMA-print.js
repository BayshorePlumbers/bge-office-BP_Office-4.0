...
const COMSAMA_DEFAULT_RETURN_URL = "comSAMA.html";
...
(function () {
  ...
  function getReturnUrl() {
    return sessionStorage.getItem(COMSAMA_PRINT_RETURN_KEY) || COMSAMA_DEFAULT_RETURN_URL;
  }

  function cleanupPrintSession() {
    sessionStorage.removeItem(COMSAMA_PRINT_PAYLOAD_KEY);
    sessionStorage.removeItem(COMSAMA_PRINT_RETURN_KEY);
  }
  ...
  function renderPayload() {
    const payload = sessionStorage.getItem(COMSAMA_PRINT_PAYLOAD_KEY);
    const root = document.getElementById("printRoot");
